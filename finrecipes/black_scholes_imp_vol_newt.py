...
def option_price_implied_volatility_call_black_scholes_newton( \
    ...
    for i in range(MAX_ITERATIONS):
        ...
        vega = S * t_sqrt * finrecipes.normdist.n(d1)
...
if __name__=="__main__":
    from finrecipes.black_scholes_imp_vol_bisect import option_price_implied_volatility_call_black_scholes_bisections
    ...
    print()
    from finrecipes.black_scholes_imp_vol_bisect import option_price_implied_volatility_put_black_scholes_bisections
