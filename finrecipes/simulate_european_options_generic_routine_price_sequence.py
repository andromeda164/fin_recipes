...
*******************************************************"""
import math, random
from finrecipes.simulate_lognormally_distributed_sequence import *
...
if __name__=="__main__":
    ...
    import finrecipes.payoff_average
    numtrials = 10000
    numsteps = 200
    S = 100.0
    X = 100.0
    ...
    value, delta, gamma, vega, rho = \
        derivative_price_simulate_european_option_generic( \
            S, X, r, sigma, time, finrecipes.payoff_average.payoff_arithmetric_average_call, \
            numsteps, numtrials)
