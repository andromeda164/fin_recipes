...
class calendar:
    ...
    def __init__(self, off_dates):
        ...
        for off_date in off_dates:
            ...
            data = finrecipes.dates.date('EU',off_date)
    ...
    def is_businessday(self, datum):
        ...
        if type(datum)==type(''):
            try:
                datum=finrecipes.dates.date('autodetect',datum)
            except:
...
if __name__ == "__main__":
    ...
    class CalendarTestAllValuesTARGET(CalendarTestTARGET):
        def testAllValues(self):
            ...
            start = finrecipes.dates.date('EU','31.12.1999')
            end = finrecipes.dates.date('EU','31.12.2010')
            run = start
