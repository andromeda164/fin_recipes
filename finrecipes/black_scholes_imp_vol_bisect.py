...
if __name__=="__main__":
    from finrecipes.black_scholes_imp_vol_newt import option_price_implied_volatility_call_black_scholes_newton
    ...
    print()
    from finrecipes.black_scholes_imp_vol_newt import option_price_implied_volatility_put_black_scholes_newton
